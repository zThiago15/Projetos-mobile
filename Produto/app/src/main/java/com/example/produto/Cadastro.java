    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSalvar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                } else if(txCodigobar.length() < 13){
                    txCodigobar.setError("Precisa ter 13 números no mínimo");
    ...
    private void criarPopupConfirmarCadastro() {
        ...
        btnConfirmarCadastro.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                telaMostrar();
                Toast.makeText(Cadastro.this,"Produto cadastrado com sucesso!", Toast.LENGTH_SHORT).show();
